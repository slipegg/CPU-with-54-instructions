...
create_clock -period 400.000 -name clk_pin -waveform {0.000 200.000} [get_ports clk_in]
set_input_delay -clock [get_clocks *] 20.000 [get_ports reset]
set_output_delay -clock [get_clocks *] 20.000 [get_ports -filter { NAME =~  "*" && DIRECTION == "OUT" }]
